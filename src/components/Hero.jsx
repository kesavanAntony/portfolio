    ...
    <div className=' lg:mb-36'>
      <div className="flex flex-wrap lg:flex-row-reverse">
        ...
        <div className="flex justify-center lg:p-8">
            <motion.img src={profile} alt="Kesavanraj" className='border border-stone-900 rounded-3xl'
            width={650}
            height={650}
        ...
        variants={containerVariants} className="flex flex-col items-center lg:items-start mt-10">
         <motion.h2 variants={childVariants} className="pb-2 text-4xl tracking-tighter lg:text-8xl">
            Kesavanraj A</motion.h2>
            <motion.span className="bg-gradient-to-r from-stone-300 to-stone-600 bg-clip-text text-3xl tracking-tight text-transparent" variants={childVariants}>
                Full Stack Developer</motion.span>
                <motion.p variants={childVariants} className="my-2 max-w-lg py-6 text-xl text-justify leading-relaxed tracking-tighter">
                    {HERO_CONTENT}
                    </motion.p>
